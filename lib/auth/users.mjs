 ...
 *  tahsin@lostmodesty.com / raat-jaaga-1  (author, new-scheme hash)
 *  rumki@lostmodesty.com  / modhyobortini-2 (author, new-scheme hash)
 *  nila@example.com       / porano-shohor (migrated reader, LEGACY hash) */
const SEED = [
  {
    id: "u-1001",
    email: "tahsin@lostmodesty.com",
    name: "তাহসিন আহমেদ",
    bio: "গদ্য আর ধারাবাহিক গল্প লেখেন।",
    role: "author",
    authorSlug: "tahsin",
